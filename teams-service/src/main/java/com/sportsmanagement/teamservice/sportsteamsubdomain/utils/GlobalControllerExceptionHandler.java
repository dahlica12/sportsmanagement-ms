package com.sportsmanagement.teamservice.sportsteamsubdomain.utils;
...
public class GlobalControllerExceptionHandler {
    ...
    public HttpErrorInfo handleDuplicateIdentifierException(WebRequest request, Exception ex) {
        return createHttpErrorInfo(UNPROCESSABLE_ENTITY, request, ex);
